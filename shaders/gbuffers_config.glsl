...
#define GBUFFER_DEBUG NOTHING //What to draw in gbuffers_textured. For CONSTANT, see the key in the zip file. [NOTHING LMCOORD LIGHTMAP GL_NORMAL GL_NORMALMATRIX MC_MIDTEXCOORD AT_TANGENT GL_COLOR NORMALS_TEXTURE SPECULAR_TEXTURE GL_VERTEX PLAYER_POS WORLD_POS VIEW_POS SHADOW_VIEW_POS SHADOW_SAMPLE_POS SHADOWCOLOR0 NUMERIC_ID PROGRAM_ID]
