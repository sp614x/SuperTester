...
#define TEXTURE 22
#define GBUFFER_DEBUG NOTHING //What to draw in gbuffers_textured. For CONSTANT, see the key in the zip file. [NOTHING TEXTURE LMCOORD LIGHTMAP GLX_NORMAL GLX_NORMALMATRIX MC_MIDTEXCOORD AT_TANGENT AT_TANGENTMATRIX AT_VELOCITY AT_MIDBLOCK GLX_COLOR NORMALS_TEXTURE SPECULAR_TEXTURE GLX_VERTEX PLAYER_POS WORLD_POS VIEW_POS SHADOW_VIEW_POS SHADOW_SAMPLE_POS SHADOWCOLOR0 NUMERIC_ID PROGRAM_ID]
